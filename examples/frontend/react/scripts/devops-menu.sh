#!/usr/bin/env bash
###############################################################################
# devops-menu.sh -- DevOps helper menu for the React 19 IAM-Keycloak example
###############################################################################
set -euo pipefail
...
print_header() {
    ...
    echo -e "${BLUE}${BOLD}"
    echo "============================================================"
    echo "  React 19 (Vite) -- IAM-Keycloak DevOps Menu"
    echo "============================================================"
    echo -e "${NC}"
...
build_docker_image() {
    cd "${PROJECT_DIR}"
    run_cmd "Docker image build" docker build -t react-iam .
}
